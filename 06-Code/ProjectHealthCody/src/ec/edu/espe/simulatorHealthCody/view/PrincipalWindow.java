...
public class PrincipalWindow extends javax.swing.JFrame {
    ...
    public static ButtonGroup getSelectRegistry() {
        return SelectRegistry;
    }

    public static void setSelectRegistry(ButtonGroup SelectRegistry) {
        PrincipalWindow.SelectRegistry = SelectRegistry;
    }
    ...
    public JLabel getImgWallpaper() {
        return imgWallpaper;
    }

    public void setImgWallpaper(JLabel imgWallpaper) {
    ...
    public JRadioButton getRdbCustomer() {
        return rdbCustomer;
    }

    public void setRdbCustomer(JRadioButton rdbCustomer) {
        this.rdbCustomer = rdbCustomer;
    }

    public JRadioButton getRdbEmployee() {
        return rdbEmployee;
    }

    public void setRdbEmployee(JRadioButton rdbEmployee) {
        this.rdbEmployee = rdbEmployee;
    }

    public JTextField getTxpPassword() {
        return txpPassword;
    }

    public void setTxpPassword(JTextField txpPassword) {
